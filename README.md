...
✨ Features:
1) Borderless, draggable widget window
2) Digital clock with blinking colon
3) Smooth fade-in and fade-out animations
4) Custom application icon (.ico)
5) Lightweight and standalone executable
6) Built for Windows 11 (25H2 compatible)
...
> Desktop widget-style application behavior
